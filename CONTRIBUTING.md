...
[create a proposal](https://github.com/zendframework/zend-expressive-navigation/issues/new).
...
- Clone the repository:
  ...
  ```console
  $ git clone git://github.com/zendframework/zend-expressive-navigation.git
  $ cd {repo}
  ```
...
2. Fork the repository (https://github.com/zendframework/zend-expressive-navigation)
